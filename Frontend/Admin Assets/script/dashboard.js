...
async function dashboard(){
  ...
  try {
      ...
      let res = await fetch(`http://localhost:8888/getAdminByEmail/${email}` , {
          method: "GET",
...
function appendData(dat) {
     ...
     let adminID = document.createElement("p");
     adminID.innerText = "Admin ID: " + dat.adminID;
     ...
     user.append(adminID, name, emaill, mobile, address);
